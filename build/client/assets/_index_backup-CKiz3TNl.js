import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{R as g,F as b,H as w,S as j}from"./Footer-C2U8dAHJ.js";import{B as v,a as N,R as k,C as S,G as R,b as y,c as B,F as z,d as C,M as q}from"./lib-B-C9lLuy.js";import{r as t,L as h}from"./components-C1WRcSP2.js";import{W as H,U as E,M as F}from"./UserMenu-Do0lwhg8.js";import"./LeftNav-DinUoR8z.js";import"./AuthContext-C8OelPxa.js";import"./css-CVxtJxAn.js";import"./index-Diwzsm1_.js";const K=()=>[{title:"New Remix App"},{name:"description",content:"Welcome to Remix!"}];function O(){return e.jsxs("div",{children:[e.jsx(M,{}),e.jsx(T,{}),e.jsx(g,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx(G,{}),e.jsx(b,{})]})}const M=()=>{const[l]=t.useState(1),[o,r]=t.useState(""),[x,a]=t.useState(!1),[d,n]=t.useState(!1),[c,u]=t.useState(!1),s=()=>n(!0),i=()=>n(!1);return t.useEffect(()=>{const m=()=>{window.scrollY>=l&&a(!0),window.scrollY<l&&a(!1)};window.onscroll=()=>m()},[l]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
